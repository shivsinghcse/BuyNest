            ...
            <div className="flex md:flex-row flex-col h-screen items-center md:gap-12 md:px-16 px-4 md:justify-center md:mt-0 mt-8">
                ...
                <div className="md:w-6/12 w-11/12 flex flex-col gap-6 md:p-6 p-2 animate__animated animate__pulse">
                    ...
                    <form className="flex flex-col gap-6" onSubmit={login}>
                        ...
                        <button className="border-2 border-(--primary-color) w-full py-2 text-lg font-semibold text-(--primary-color) hover:cursor-pointer hover:bg-(--primary-color) hover:text-white transition duration-300 mt-2">Login</button>
